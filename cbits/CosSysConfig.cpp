...
unsigned CosSysConfig::m_threadpool_size =
    DEFAULT_THREAD_POOL_SIZE_UPLOAD_SLICE;
...
CosSysConfig::print_value()
{
    ...
    std::cout << "timeout_for_entire_request_in_ms:"
              << timeout_for_entire_request_in_ms << std::endl;
    ...
    std::cout << "log_outtype:" << log_outtype << std::endl;
    std::cout << "down_thread_pool_max_size:" << m_down_thread_pool_max_size
              << std::endl;
    std::cout << "down_slice_size:" << m_down_slice_size << std::endl;
}

void
CosSysConfig::setIsTakeSha(bool isTakeSha)
{
    takeSha = isTakeSha;
}

void
CosSysConfig::setSliceSize(uint64_t slice_size)
{
    sliceSize = slice_size;
}

void
CosSysConfig::setDownThreadPoolMaxSize(unsigned size)
{
    if (size > 10) {
...
void
CosSysConfig::setDownSliceSize(unsigned slice_size)
{
...
unsigned
CosSysConfig::getDownThreadPoolMaxSize()
{
    return m_down_thread_pool_max_size;
}

unsigned
CosSysConfig::getDownSliceSize()
{
    return m_down_slice_size;
}

void
CosSysConfig::setExpiredTime(uint64_t time)
{
    expire_in_s = time;
}
void
CosSysConfig::setTimeoutInms(uint64_t time)
{
    timeout_in_ms = time;
}
void
CosSysConfig::setGlobalTimeoutInms(uint64_t time)
{
    timeout_for_entire_request_in_ms = time;
}
void
CosSysConfig::setL5Modid(int64_t modid)
{
    l5_modid = modid;
}
void
CosSysConfig::setL5Cmdid(int64_t cmdid)
{
    l5_cmdid = cmdid;
}

void
CosSysConfig::setUploadThreadPoolSize(unsigned size)
{
...
void
CosSysConfig::setAsynThreadPoolSize(unsigned size)
{
    // 异步线程池不设置上限
...
unsigned
CosSysConfig::getAsynThreadPoolSize()
{
    return m_asyn_threadpool_size;
}

unsigned
CosSysConfig::getUploadThreadPoolSize()
{
    return m_threadpool_size;
}

void
CosSysConfig::setLogOutType(LOG_OUT_TYPE log)
{
    log_outtype = log;
}

int
CosSysConfig::getLogOutType()
{
    return (int)log_outtype;
}

void
CosSysConfig::setRegionAndDLDomain(string region, DLDomainType type,
                                   string domain)
{
    m_region       = region;
...
string
CosSysConfig::getDownloadDomain()
{
    return downloadDomain;
}

string
CosSysConfig::getUploadDomain()
{
    return m_uploadDomain;
}

DLDomainType
CosSysConfig::getDownloadDomainType()
{
    return domainType;
}

bool
CosSysConfig::isTakeSha()
{
    return takeSha;
}

uint64_t
CosSysConfig::getSliceSize()
{
    return sliceSize;
}

uint64_t
CosSysConfig::getExpiredTime()
{
    return expire_in_s;
}

uint64_t
CosSysConfig::getTimeoutInms()
{
    return timeout_in_ms;
}
uint64_t
CosSysConfig::getGlobalTimeoutInms()
{
    return timeout_for_entire_request_in_ms;
}
int64_t
CosSysConfig::getL5Modid()
{
    return l5_modid;
}
int64_t
CosSysConfig::getL5Cmdid()
{
    return l5_cmdid;
}
}
